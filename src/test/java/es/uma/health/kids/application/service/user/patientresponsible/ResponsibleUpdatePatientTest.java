...
public class ResponsibleUpdatePatientTest {
	...
	public void parametrizedUserTest(User user) {
		...
		assertEquals(expectedPatient.fullName(), new PatientFullName("Name", "Surname"));
		assertEquals(expectedPatient.birthdate(), LocalDate.of(2012, 5, 1));
		assertEquals(expectedPatient.weight(), new Weight(22));
		assertEquals(expectedPatient.height(), new Height(120));
	}
